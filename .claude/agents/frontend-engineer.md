...
description: Implements Expo/React Native frontend tasks — screens, components, navigation, and UI logic. Use for any mobile UI implementation work assigned in the plan. Stack is Expo SDK + TypeScript.
