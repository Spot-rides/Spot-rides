---
name: planner
description: Converts approved requirements and architecture into a dependency-ordered implementation plan with granular tasks. Use after architecture is approved.
model: inherit
---
