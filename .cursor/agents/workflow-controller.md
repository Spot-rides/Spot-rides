...
description: Evaluates the final feature gate — verifies all upstream stages (requirements, architecture, plan, implementation, tests, review, security) have passed and emits READY or BLOCKED.
model: inherit
readonly: true
---
